...
FEATURES = {
    "free": {
        "positionnement": "Découverte intelligente — tous les modules sont visibles, mais l'usage reste volontairement court pour créer l'envie d'upgrader.",
        "rations_par_mois": 3,
        "diagnostics_vetscan_par_mois": 1,
        "floravet_analyses_par_mois": 1,
    ...
    "standard": {
        ...
        "rations_par_mois": 80,
        "diagnostics_vetscan_par_mois": 12,
        "floravet_analyses_par_mois": 10,
    ...
    "premium": {
        ...
        "reprotrack_illimite": True,
        "farmmanager_rapports_pdf": True,
        "pasturemap": True,
        "farmcast_contenus_par_mois": 12,
        "farmcommunity_marketplace_avance": True,
        "projections_financieres": True,
        "exports_pdf_illimites": True,
        "historique_illimite": True,
        "support": "prioritaire",
        "bonus_gamification": "+800 🌟 activation Premium",
        "upgrade_trigger": "VIP ajoute l'équipe, les rôles, le suivi techniciens et l'accompagnement expert.",
    },
    "vip": {
