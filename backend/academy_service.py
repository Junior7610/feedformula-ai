...
def _make_species_formation(species: Dict[str, Any], order: int) -> Dict[str, Any]:
    ...
    return {
        ...
        "duree": "6h à 8h",
        "points": 400,
        "resume": f"Parcours zéro-débutant pour apprendre de bout en bout comment lancer, conduire, rentabiliser et développer un élevage de {nom.lower()}, même sans aucune expérience préalable.",
        "icone": icone,
        "ordre": order,
        ...
        "cycle": species["cycle"],
        "premium": True,
        "competences": ["Démarrage sans expérience", "Installation", "Conduite quotidienne", "Nutrition", "Santé", "Reproduction", "Rentabilité", "Vente", "Expansion"],
        "public_cible": "Débutant absolu qui veut se lancer dans l'élevage sans connaître le domaine.",
        "promesse": f"À la fin, l'apprenant sait préparer, lancer et gérer un élevage de {nom.lower()} de façon mesurable et rentable.",
        "lecons": [
            {"numero": 1, "titre": f"Découvrir le {nom} avant d'investir", "objectif": f"Comprendre à quoi ressemble réellement l'élevage de {nom}, ses avantages, contraintes, risques et revenus possibles.", "questions": 5},
            {"numero": 2, "titre": "Choisir son modèle d'élevage et son objectif", "objectif": "Décider entre production familiale, semi-commerciale ou commerciale, et choisir un objectif réaliste.", "questions": 5},
            {"numero": 3, "titre": "Budget de démarrage et matériel nécessaire", "objectif": "Lister le matériel, estimer l'investissement initial en FCFA et éviter les achats inutiles.", "questions": 5},
            {"numero": 4, "titre": "Bâtiment, logement, densité et bien-être", "objectif": "Construire ou aménager un logement sain, ventilé, sécurisé et adapté à l'espèce.", "questions": 5},
            {"numero": 5, "titre": "Choisir et acheter ses premiers animaux", "objectif": "Sélectionner des sujets sains, éviter les mauvais fournisseurs et organiser la quarantaine.", "questions": 5},
            {"numero": 6, "titre": "Alimentation de base et eau propre", "objectif": "Comprendre les besoins alimentaires, l'eau, les transitions et les erreurs qui coûtent cher.", "questions": 5},
            {"numero": 7, "titre": "Routine quotidienne de l'éleveur", "objectif": "Savoir quoi faire matin, midi et soir : observation, distribution, nettoyage, notes et alertes.", "questions": 5},
            {"numero": 8, "titre": "Santé, biosécurité et premiers signes d'alerte", "objectif": "Prévenir maladies, parasites, mortalités et savoir quand utiliser VetScan ou appeler un vétérinaire.", "questions": 5},
            {"numero": 9, "titre": "Croissance, reproduction ou production", "objectif": "Suivre GMQ, ponte, lait, reproduction, fertilité ou survie selon l'espèce.", "questions": 5},
            {"numero": 10, "titre": "Registres, données et gestion avec FarmManager", "objectif": "Tenir les registres indispensables : achats, ventes, mortalité, poids, traitements, stocks et tâches.", "questions": 5},
            {"numero": 11, "titre": "Coût de revient, marge et prix de vente", "objectif": "Calculer les charges, le seuil de rentabilité, la marge nette et le prix minimum de vente.", "questions": 5},
            {"numero": 12, "titre": "Vendre, fidéliser et préparer le cycle suivant", "objectif": "Trouver des clients, vendre au bon moment, analyser le cycle et planifier l'expansion.", "questions": 5},
        ],
    }
...
def _formation_card_payload(formation: Dict[str, Any]) -> Dict[str, Any]:
    return {
        ...
        "public_cible": formation.get("public_cible", "Éleveurs et porteurs de projet"),
        "promesse": formation.get("promesse", "Acquérir une compétence pratique utilisable sur la ferme."),
...
def _build_lesson_payload(
    ...
    return {
        ...
        "accompagnement_debutant": {
            "niveau_depart": "Aucune connaissance requise",
            "mots_cles_expliques": ["lot", "ration", "mortalité", "GMQ", "biosécurité", "coût de revient"],
            "avant_de_commencer": [
                "Définir son objectif : consommer, vendre localement ou produire régulièrement.",
                "Préparer un petit budget écrit en FCFA.",
                "Identifier un espace propre, ventilé et sécurisé.",
                "Prévoir eau propre, carnet de suivi et fournisseur fiable.",
            ],
            "preuve_de_maitrise": "L'apprenant doit pouvoir expliquer quoi acheter, comment loger, nourrir, surveiller, soigner, vendre et calculer la marge.",
        },
    }
    ...
    return {
        **_formation_card_payload(formation),
        ...
        "roadmap_debutant": [
            ...
            {"etape": 3, "titre": "Démarrer petit mais propre", "resultat": "Acheter des animaux sains et éviter les pertes de débutant."},
            {"etape": 4, "titre": "Conduire chaque jour", "resultat": "Nourrir, observer, nettoyer, noter et corriger."},
            {"etape": 5, "titre": "Vendre et améliorer", "resultat": "Calculer la marge, apprendre du cycle et préparer le suivant."},
        ],
        "experience": {
